...
class assign extends Expression {
	...
	public void code(PrintStream s) {
        ...
        x.emitStore(s);
        CgenSupport.emitAddiu(CgenSupport.A1,CgenSupport.SELF,x.getOffset(),s);
